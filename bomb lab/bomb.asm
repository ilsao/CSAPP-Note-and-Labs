...
0000000000400efc <phase_2>:
  ...
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>  ; read six numbers to registers
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                ; if (M[%rsp] != 1) explode
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>

                              ; --- Loop Body ---
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax            ; %eax = M[%rbx-0x4]
  400f1a:	01 c0                	add    %eax,%eax                  ; %eax *= 2
  400f1c:	39 03                	cmp    %eax,(%rbx)                ; if (M[%rbx] != %eax) explode
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>


  400f25:	48 83 c3 04          	add    $0x4,%rbx                  ; %rbx += 0x4
  400f29:	48 39 eb             	cmp    %rbp,%rbx                  ; for (%rbx; %rbx != %rbp; %rbx += 0x4)
...
0000000000400f43 <phase_3>:
  ...
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax                    ; %eax = 0x0
                                ; sscanf("<user input>", "%d %d", &rdx, &rcx)
                                ; Let userinput[2] = <user input>
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)               ; if (userinput[0] > 0x7) explode
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax               ; %eax = userinput[0]

                              ; --- Jump Table ---
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)           ; jmp (8*userinput[0] + 0x402470)
                              ; 0x400f7c
                              ; 0x400fb9
                              ; 0x400f83
                              ; 0x400f8a
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax             ; if (%eax = userinput[1]) defused
...
; func4(%rdi, %rsi, %rdx)
; func4(userinput[0], 0x0, 0xe)
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax            ; %eax = param3
  400fd4:	29 f0                	sub    %esi,%eax            ; %eax -= param2
  400fd6:	89 c1                	mov    %eax,%ecx            ; %ecx = param3 - param2
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx           ; %ecx >> 31 (get sign)
  400fdb:	01 c8                	add    %ecx,%eax            ; %eax += %ecx
  400fdd:	d1 f8                	sar    %eax                 ; %eax /= 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   ; %ecx = %rax + param2
  400fe2:	39 f9                	cmp    %edi,%ecx            ; if (%ecx <= param1) goto 0x400ff2
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx      ; %edx = %rcx - 0x1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>       ; func4(param1, %rsi, %rcx - 0x1)
  400fee:	01 c0                	add    %eax,%eax            ; %eax *= 2
  400ff0:	eb 15                	jmp    401007 <func4+0x39>  
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax            ; %eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx            ; if (%ecx >= param1) goto 0x401007
...
000000000040100c <phase_4>:
  ...
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> ; let user input userinput[2]
  401029:	83 f8 02             	cmp    $0x2,%eax                    ; explode condition
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)               ; if (userinput[0] > 0xe) explode
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi               ; func4(userinput[0], 0x0, 0xe)
  401048:	e8 81 ff ff ff       	callq  400fce <func4>               ; func4(%rdi, %rsi, %rdx)
  40104d:	85 c0                	test   %eax,%eax                    ; if (%eax != 0) explode
  40104f:	75 07                	jne    401058 <phase_4+0x4c>        
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)               ; if (userinput[1] == 0x0) defuse
...
0000000000401062 <phase_5>:
  ...
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax          ; Get canary
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)        ; %rsp + 0x18 = canary
  401078:	31 c0                	xor    %eax,%eax
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length> ; string_length()
  40107f:	83 f8 06             	cmp    $0x6,%eax              ; if (string_length() == 6) jmp 0x4010d2
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
                                                              ; %rax = counter = 0
                                                              ; %rbx = %rdi = <user input>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx     ; %ecx = userinput[%rax]   <-Loop Head
  40108f:	88 0c 24             	mov    %cl,(%rsp)             ; M[%rsp] = %cl
  401092:	48 8b 14 24          	mov    (%rsp),%rdx            ; %rdx = %cl
  401096:	83 e2 0f             	and    $0xf,%edx              ; %edx & 0xf
                                ; M[0x4024b0] = "maduiersnfotvbylSo"
  ...
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax              ; if (%rax != 0x6) jmp Loop Head
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)        ; M[%rsp + 0x16] = 0 // put '\0' at the end
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi         ; %esi = $0x40245e = "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi        ; %rdi = %rsp + 0x10
                                                              ; -> We have to get "0x9 0xf 0xe 0x5 0x6 0x7"
                                                              ; "9/.567"
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>        ; if (strings_not_equal()) explode
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax                    ; If first check done, will jmp here 
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>        ; %eax = 0
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax              ; %rax = M[%rsp + 0x18] // Get Canary
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax                ; if (%rax != canary) stack_chk_fail
  4010e5:	00 00 
...
; Check 1: All num in userinput must be under(or equal) 0x6, and we cannot have any two same number in userinput
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                 ; %r12d = 0x0 (initialize counter)
  401114:	4c 89 ed             	mov    %r13,%rbp                  ; %rbp = %r13
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax             ; %eax = M[%r13] = userinput[i] (i from 0 to 5)
  40111b:	83 e8 01             	sub    $0x1,%eax                  ; %eax--;
  40111e:	83 f8 05             	cmp    $0x5,%eax                  ; if (%eax > 0x5) explode
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d                 ; %r12d += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                 ; if (%r12d == 0x6) jmp 0x401153
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx                 ; %ebx = %r12d
  401135:	48 63 c3             	movslq %ebx,%rax                  ; %rax = %ebx      <-- Loop Head 1
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax         ; %eax = M[%rsp + %rax * 4] (Get userinput[i+1], i from 0 to 4. Skip userinput[0] since we've discussed it at 0x401117)
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)             ; if (M[%rbp] == %eax) explode (explode if it has any num equaled to userinput[i])
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                  ; %ebx += 0x1
  401148:	83 fb 05             	cmp    $0x5,%ebx                  ; if (%ebx <= 0x5) jmp Loop Head 1
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13                  ; %r13 += 0x4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>      ; jmp Check 1 Loop

; Modify: userinput[i] = 0x7 - userinput[i], i from 0 to 5
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi            ; %rsi = %rsp + 0x18 = 0x0
  401158:	4c 89 f0             	mov    %r14,%rax                  ; %rax = %r14 = userinput[0]
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                  ; %ecx = 0x7
  401160:	89 ca                	mov    %ecx,%edx                  ; %edx = %ecx       <-- Loop Head 2 
  401162:	2b 10                	sub    (%rax),%edx                ; %edx -= M[%rax]
  401164:	89 10                	mov    %edx,(%rax)                ; M[%rax] = %edx
  401166:	48 83 c0 04          	add    $0x4,%rax                  ; %rax += 0x4
  40116a:	48 39 f0             	cmp    %rsi,%rax                  ; if (%rax != %rsi) jmp Loop Head 2
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>

; struct Node {
;   int val;    // 4bytes + (4bytes bias)
;   Node* next; // 8bytes
;};
; Store: store Node1 ~ Node6 into M[%rsp + 0x20] ~ M[%rsp + 0x28 + 0x20], the same order to modified userinput
; We named %rsp + 0x20 ~ %rsp + 0x28 + 0x20 to Node **NodeList[6]
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                  ; %esi = 0x0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>      ; jmp 0x401197
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx             ; %rdx = M[%rdx + 0x8]<-- Loop Head 4 Node = Node -> next
  40117a:	83 c0 01             	add    $0x1,%eax                  ; %eax += 0x1
  40117d:	39 c8                	cmp    %ecx,%eax                  ; if (%eax != %ecx) jmp   Loop Head 4
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>      ; jmp 0x401188
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx             ; %edx = 0x6032d0   <-- Loop Head 3
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)     ; M[%rsp + %rsi * 2 + 0x20] = %rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi                  ; %rsi += 0x4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                 ; if (%rsi == 0x18) jmp 0x4011ab
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx         ; %ecx = M[%rsp + %rsi] = userinput[i](modified)
  40119a:	83 f9 01             	cmp    $0x1,%ecx                  ; if (%ecx <= 0x1) jmp  Loop Head 3
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>      ; (if userinput[i](before modified) == 0x6) M[%rsp + 0x20] = 0x6032d0(The first Node)
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                  ; %eax = 0x1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx             ; %edx = 0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>      ; jmp                      Loop Head 4

; Update Node1 ~ Node6, make the whole list node has the same order with NodeList
; We named the new NodeList Node **NewNodeList[6]
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx            ; %rbx = M[%rsp + 0x20] = *NodeList[0]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax            ; %rax = %rsp + 0x28 = NodeList[1]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi            ; %rsi = %rsp + 0x50 
  4011ba:	48 89 d9             	mov    %rbx,%rcx                  ; %rcx = %rbx = *NodeList[0]
  4011bd:	48 8b 10             	mov    (%rax),%rdx                ; %rdx = M[%rax]  <--- Loop Head 5 = *NodeList[1]
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)             ; M[%rcx + 0x8] = %rdx (*NodeList[0]->next = *NodeList[1])
  4011c4:	48 83 c0 08          	add    $0x8,%rax                  ; %rax += 0x8 (%rax = NodeList[1 + i], i from 1 to 4)
  4011c8:	48 39 f0             	cmp    %rsi,%rax                  ; if (%rax == %rsi) jmp 0x4011d2
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx                  ; %rcx = %rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>      ; jmp                  Lood Head 5
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)             ; M[%rdx + 0x8] = 0x0 (*NodeList[5] -> next = nullptr)
  4011d9:	00 
...
; Node6->val: 0x1bb = 443
;
; => modified userinput[6] = 3 4 5 6 1 2
; => userinput[6] = 4 3 2 1 6 5
; 
; Check2: we have to let the whole list node in order from largest to smallest
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                  ; %ebp = 0x5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax             ; %rax = M[%rbx + 0x8] <--- Loop Head 6 = NewListNode[0 + 1]
  4011e3:	8b 00                	mov    (%rax),%eax                ; %eax = M[%rax] = *NewListNode[0 + 1] -> val
  4011e5:	39 03                	cmp    %eax,(%rbx)                ; if (M[%rbx] < %eax) explode (explode if *NewListNode[0]->val < *NewListNode[0 + 1] -> val)
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx             ; %rbx = M[%rbx + 0x8] = *NewNodeList -> next
  4011f2:	83 ed 01             	sub    $0x1,%ebp                  ; %ebp -= 0x1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>      ; if (%ebp != 0) jmp        Loop Head 6
...
; %rdx, %rcx, %rsp+0x8, %rsp, %r9, %r8, %esi
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp
  401460:	48 89 f2             	mov    %rsi,%rdx        ; input arg (%rsi = %rsp in phase_2)
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx   ; %rcx = %rsi+0x4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)   ; M[%rsp+0x8] = %rsi+0x14
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)      ; M[%rsp] = %rsi+0x10
  ...
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d> ; if (%eax <= 5) explode
